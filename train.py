...
import datasets.UCM
import datasets.AID
import datasets.RSSCN7
import datasets.PatternNet
import datasets.MLRSNet
import datasets.RSICD
import datasets.nwpuv2
import datasets.WHURS19v2
import datasets.UCMv2
import datasets.AIDv2
import datasets.RSSCN7v2
import datasets.PatternNetv2
import datasets.MLRSNetv2
import datasets.RSICDv2
import datasets.RSD46
import datasets.MEMNIST
import datasets.CHMNIST
import datasets.BTMRI
import datasets.Kvasir
import datasets.TMR17
import datasets.COVID19
import datasets.CCBTM
import datasets.CCBTMv2
import datasets.CHMNISTv2
import datasets.BTMRIv2
import datasets.ship
import datasets.airplane
import datasets.MSTAR
import datasets.fluidxyz
import datasets.fluiduvw
import datasets.rock_image_x
import datasets.rock_image_y
import datasets.rock_image_z
