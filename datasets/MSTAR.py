...
class MSTAR(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.image_dir = os.path.join(self.dataset_dir, "MSTAR")
        self.split_path = os.path.join(self.dataset_dir, "split_cao_MSTAR.json")
